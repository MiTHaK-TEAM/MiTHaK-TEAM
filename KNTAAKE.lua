...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/BASHA-TEAM/BASHA/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,883938507,694635826}   
...
os.execute('wget https://raw.githubusercontent.com/BASHA-TEAM/BASHA/master/KNTAAKE.lua')
...
⧉️↬𝗕𝗔𝗦𝗛𝗔 𝗦𝗢𝗨𝗥𝗖𝗘
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⧉️↬[𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒃𝒂𝒔𝒉𝒂](https://t.me/D666N)

⧉️↬[𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑](https://t.me/S666F)

⧉️↬[𝐓𝐨 𝐭𝐚𝐥𝐤 𝐭𝐨 𝐮𝐬](https://t.me/S666FBOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if DevKNTAAKEW(msg)  then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BASHA-TEAM/BASHA/master/File_Bot/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⌁︙ اهلا بك في متجر ملفات باشا\n ⌁︙ ملفات السورس ↓\n『─────·𖤐·─────』\n\n"
local TextE = "\n『─────·𖤐·─────』\n ⌁︙ علامة تعني { ✓ } ملف مفعل\n ⌁︙ علامة تعني { ✘ } ملف معطل\n ⌁︙ قناة سورس باشا ↓\n".." ⌁︙ [اضغط هنا لدخول](t.me/D666N) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/BASHA-TEAM/BASHA/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('KNTAAKE.lua')  
else
send(msg.chat_id_, msg.id_," ⌁︙ عذرا الملف لايدعم سورس باشا \n") 
end
return false
end
...
usertext = '\n ⌁︙  المستخدم » ['..result.title_..'](t.me/'..(username or 'D666N')..')'
status  = '\n ⌁︙ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
